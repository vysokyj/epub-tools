...
<!-- file: xhtml-qname-1.mod
     ...
     This epubdtd module is identified by the PUBLIC and SYSTEM identifiers:

       PUBLIC "-//W3C//ENTITIES XHTML Qualified Names 1.0//EN"
       SYSTEM "http://www.w3.org/TR/xhtml-modularization/epubdtd/xhtml-qname-1.mod"
...
<!-- 1. Declare a %XHTML.prefixed; conditional section keyword, used
        ...
        inherit '%NS.prefixed;' from the epubdtd driver, so that unless
        overridden, the default behaviour follows the overall epubdtd
        prefixing scheme.
-->
...
<!-- 3. Declare parameter entities (eg., %XHTML.prefix;) containing
        ...
        is enabled. This may be overridden in the epubdtd driver or the
...
<!-- Declare a parameter entity %NS.decl.attrib; containing
     all XML Namespace declarations used in the epubdtd, plus the
