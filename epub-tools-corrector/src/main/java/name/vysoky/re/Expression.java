...
public class Expression {
    ...
    public Expression(String comment, String expression) throws IllegalArgumentException {
        this.comment = comment;
        this.expression = expression;
        parseExpression();
        if (Replacer.isVerbose()) System.out.println("Used regular expression: " + expression + " " + comment);
    }
